...
export const updateMessageAvatar = (avatarUri) => ({
    type: MESSAGE_UPDATE_AVATAR,
    payload: {
        avatarUri
    }
});
...
export const failFetchingMessageAvatar = errorActionFactory(MESSGE_FETCHING_AVATAR_FAILED);